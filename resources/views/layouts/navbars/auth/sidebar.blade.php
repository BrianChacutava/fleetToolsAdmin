<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3"
    ...
    <div class="sidenav-header">
        ...
        <a class="align-items-center d-flex m-0 navbar-brand text-wrap" href="{{ route('dashboard') }}">
            <img src="../assets/img/Fleet_Logo.png" class="navbar-brand-img h-100" alt="...">
            {{-- <span class="ms-3 font-weight-bold">Fleetmatics Africa Lda</span> --}}
        </a>
    </div>
    ...
    <div class="collapse navbar-collapse w-auto" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item mt-2">
                <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">Tools Management</h6>
            </li>
            <li class="nav-item">
                <a class="nav-link {{ Route::currentRouteName() == 'tool-list' ? 'active' : '' }}"
                    href="{{ route('tool-list') }}">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i style="font-size: 1rem;" class="fas fa-lg fa-list-ul ps-2 pe-2 text-center
                        {{ in_array(request()->route()->getName(),['tool-list']) ? 'text-white' : 'text-dark' }}"></i>
                    </div>
                    <span class="nav-link-text ms-1">List Tool</span>
                </a>
            </li>
            <li class="nav-item pb-2">
                <a class="nav-link {{ Route::currentRouteName() == 'tool-create' ? 'active' : '' }}"
                    href="{{ route('tool-create') }}">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i style="font-size: 1rem;" class="fa fa-plus ps-2 pe-2 text-center
                        {{ in_array(request()->route()->getName(),['tool-create']) ? 'text-white' : 'text-dark' }}"></i>
                    </div>
                    <span class="nav-link-text ms-1">Create Tool</span>
                </a>
            </li>
            <li class="nav-item pb-2">
                <a class="nav-link {{ Route::currentRouteName() == 'Tool-Request' ? 'active' : '' }}"
                    href="{{ route('Tool-Request') }}">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i style="font-size: 1rem;" class="fa fa-paper-plane ps-2 pe-2 text-center
                        {{ in_array(request()->route()->getName(),['Tool-Request']) ? 'text-white' : 'text-dark' }}"></i>
                    </div>
...
{{--        ......................................................................................... --}}
            ...
            <li class="nav-item pb-2">
                <a class="nav-link {{ Route::currentRouteName() == 'Product-Request' ? 'active' : '' }}"
                    href="{{ route('Product-Request') }}">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i style="font-size: 1rem;" class="fa fa-paper-plane ps-2 pe-2 text-center
                        {{ in_array(request()->route()->getName(),['Product-Request']) ? 'text-white' : 'text-dark' }}"></i>
                    </div>
            ...
            {{-- --------------------------------------------------------------------------------------------- --}}
            <li class="nav-item mt-2">
                <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">Config</h6>
            </li>

            <li class="nav-item pb-2">
                <a class="nav-link {{ Route::currentRouteName() == 'stock-list' ? 'active' : '' }}"
                    href="{{ route('stock-list') }}">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i style="font-size: 1rem;" class="fa fa-paper-plane ps-2 pe-2 text-center
                        {{ in_array(request()->route()->getName(),['stock-list']) ? 'text-white' : 'text-dark' }}"></i>
                    </div>
            ...
            <li class="nav-item pb-2">
                <a class="nav-link {{ Route::currentRouteName() == 'employer-list' ? 'active' : '' }}"
                    href="{{ route('employer-list') }}">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i style="font-size: 1rem;" class="fas fa-lg fa-users ps-2 pe-2 text-center
                        {{ in_array(request()->route()->getName(),['employer-list']) ? 'text-white' : 'text-dark' }}"></i>
                    </div>
