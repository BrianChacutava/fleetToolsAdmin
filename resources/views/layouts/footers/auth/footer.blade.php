            ...
            <div class="col-lg-6 mb-lg-0 mb-4">
                <div class="copyright text-center text-sm text-muted text-lg-left">
                    © {{ now()->year }} Soft by <a style="color: #252f40;" href="https://fleetmaticsafrica.com/en/" class="font-weight-bold ml-1"
                        target="_blank">Fleetmaics Africa Lda</a> &amp; <a style="color: #252f40;" href="https://fleetmaticsafrica.com/contact-us/"
                        class="font-weight-bold ml-1" target="_blank">PERSONAL ICT</a>
                </div>
            </div>
            <div class="col-lg-6">
