    ...
    <div class="container-fluid py-4">
        <div class="card">
            ...
            <div class="card-body pt-4 p-3">
                ...
                <form wire:submit.prevent="save1" action="#" method="" role="form text-left">
                    <div class="row">

                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="Products" class="form-control-label">{{ __('Products') }}</label>
                                <div class="@error('req.product_id')border border-danger rounded-3 @enderror">

                                    <select wire:model="req.product_id" class="form-control" id="product_id">
                                        <option value="0">Select Products - Quantity</option>
                        ...
                        <tbody>
                            @foreach ($requestList as $request)
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex px-2 py-1">
                                            ...
                                            <div class="d-flex flex-column justify-content-center">
                                                <h6 class="mb-0 text-sm">{{ $request->product->id }}</h6>
                                    ...
                                    <td>{{ $request->operation_type == 'O' ? 'Out' : 'Entry' }}</td>
                                    <td>
