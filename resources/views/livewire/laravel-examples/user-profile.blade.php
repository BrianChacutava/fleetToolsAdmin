            ...
            <div class="row gx-4">
                <div class="col-auto">
                    <div class="avatar avatar-xl position-relative">
                        @if ($user->photo)
                            <img src="{{ asset('storage/' . $user->photo) }}" alt="..." class="w-100 border-radius-lg shadow-sm">
                        @else
                ...
                <div class="col-auto my-auto">
                    <div class="h-100">
                        <h5 class="mb-1">
                            {{ $user->name }} {{ $user->employer()->first()?->lastname }}
                        </h5>
                        <p class="mb-0 font-weight-bold text-sm">
                            {{ $user->employer()->first()?->category()->first()?->name ?? 'No Company' }}
                        </p>
                    </div>
                </div>
